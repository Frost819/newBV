...
class SearchHistoryDaoTest {
    ...
    @Test
    fun insert_multiple_and_getAll() = runTest {
        dao.insert(
    ...
    @Test
    fun getHistories_returns_by_dateDesc() = runTest {
    ...
    @Test
    fun getHistories_respects_count_limit() = runTest {
        dao.insert(
            SearchHistoryEntity(keyword = "test1"),
            SearchHistoryEntity(keyword = "test2"),
            SearchHistoryEntity(keyword = "test3")
    ...
    @Test
    fun findHistory_returns_match() = runTest {
    ...
    @Test
    fun findHistory_returns_null_when_not_found() = runTest {
    ...
    @Test
    fun delete_removes_specific_history() = runTest {
    ...
    @Test
    fun deleteAll_clears_all() = runTest {
        dao.insert(
            SearchHistoryEntity(keyword = "test1"),
            SearchHistoryEntity(keyword = "test2")
        )
    ...
    @Test
    fun update_changes_searchDate() = runTest {
    ...
    @Test
    fun getHistories_on_empty_table_returns_empty() = runTest {
        val result = dao.getHistories(10)
