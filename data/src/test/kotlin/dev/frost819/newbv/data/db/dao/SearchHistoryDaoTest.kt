...
class SearchHistoryDaoTest {
    ...
    @Test
    fun `getAll returns all records with correct field values`() =
        runTest {
    ...
    @Test
    fun `getAll returns records in insertion order when no explicit ordering`() =
        runTest {
            dao.insert(
    ...
    @Test
    fun `getHistories with count larger than table size returns all records`() =
        runTest {
            dao.insert(
    ...
    @Test
    fun `getHistories returns newest first when timestamps differ`() =
        runTest {
            dao.insert(
    ...
    @Test
    fun `getHistories preserves searchDate through Date converter round-trip`() =
        runTest {
    ...
    @Test
    fun `findHistory with unicode keyword returns correct record`() =
        runTest {
    ...
    @Test
    fun `findHistory with empty string keyword returns correct record`() =
        runTest {
    ...
    @Test
    fun `findHistory with special characters keyword returns correct record`() =
        runTest {
    ...
    @Test
    fun `findHistory is case sensitive`() =
        runTest {
            dao.insert(SearchHistoryEntity(keyword = "Test"))
    ...
    @Test
    fun `insert duplicate keyword creates separate records`() =
        runTest {
            dao.insert(
    ...
    @Test
    fun `delete multiple entities via vararg removes all specified`() =
        runTest {
    ...
    @Test
    fun `delete non-existent entity does not throw`() =
        runTest {
    ...
    @Test
    fun `delete one entity when multiple exist removes only that record`() =
        runTest {
            dao.insert(
    ...
    @Test
    fun `deleteAll removes all records leaving table empty`() =
        runTest {
            dao.insert(
    ...
    @Test
    fun `update non-existent entity does not throw and does not insert`() =
        runTest {
    ...
    @Test
    fun `update preserves id and keyword while changing date`() =
        runTest {
