...
class SearchHistoryRepositoryImplTest {
    ...
    @BeforeEach
    fun setUp() {
        tempDir = kotlin.io.path.createTempDirectory(prefix = "repo_test").toFile()
    ...
    @Test
    fun `getHistories delegates to dao with count`() = runTest {
    ...
    @Test
    fun `getHistories returns empty list when dao returns empty`() = runTest {
    ...
    @Test
    fun `addHistory inserts new keyword when not incognito`() = runTest {
    ...
    @Test
    fun `addHistory updates existing keyword when not incognito`() = runTest {
    ...
    @Test
    fun `addHistory updates searchDate of existing keyword`() = runTest {
    ...
    @Test
    fun `addHistory does nothing when incognito mode is on`() = runTest {
    ...
    @Test
    fun `addHistory with empty keyword when not incognito inserts`() = runTest {
    ...
    @Test
    fun `deleteHistory deletes when keyword exists`() = runTest {
    ...
    @Test
    fun `deleteHistory does nothing when keyword not found`() = runTest {
