...
class WatchLaterViewModelTest {
    ...
    private fun createViewModel(): WatchLaterViewModel = WatchLaterViewModel(toViewRepository = toViewRepository)

    @Test
    fun `addToView success emits ShowToast`() =
    ...
    @Test
    fun `addToView success with bvid emits ShowToast`() =
        runTest(testDispatcher) {
            coEvery {
    ...
    @Test
    fun `addToView failure emits ShowToast with error message`() =
        runTest(testDispatcher) {
            coEvery {
    ...
    @Test
    fun `addToView failure with null message emits ShowToast with unknown error`() =
        runTest(testDispatcher) {
            coEvery {
                toViewRepository.addToView(any(), any(), any())
            } throws Exception()
